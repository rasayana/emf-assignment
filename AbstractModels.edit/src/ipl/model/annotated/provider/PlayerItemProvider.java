...
/**
 * This is the item provider adapter for a {@link ipl.model.annotated.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlayerItemProvider extends AbstractEntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_team_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_team_feature", "_UI_Player_type"),
				 AnnotatedPackage.Literals.PLAYER__TEAM,
				 true,
				 false,
				 true,
				 null,
