...
/**
 * This is the item provider adapter for a {@link ipl.model.annotated.Tournament} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TournamentItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnnotatedPackage.Literals.TOURNAMENT__TEAMS);
			childrenFeatures.add(AnnotatedPackage.Literals.TOURNAMENT__VENUES);
			childrenFeatures.add(AnnotatedPackage.Literals.TOURNAMENT__MATCHES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnnotatedPackage.Literals.TOURNAMENT__TEAMS,
				 AnnotatedFactory.eINSTANCE.createTeam()));

		newChildDescriptors.add
			(createChildParameter
				(AnnotatedPackage.Literals.TOURNAMENT__VENUES,
				 AnnotatedFactory.eINSTANCE.createVenue()));

		newChildDescriptors.add
			(createChildParameter
				(AnnotatedPackage.Literals.TOURNAMENT__MATCHES,
				 AnnotatedFactory.eINSTANCE.createMatch()));
	}
